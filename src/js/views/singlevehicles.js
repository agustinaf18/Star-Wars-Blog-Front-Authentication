...
//   // useEffect(() => {
//   //   actions.obtenerInfoDeCadaVehiculo(params.theid);   //params.theid es id en flux
//   // }, []);
//   return (
//     <>
...
//           <h6 className="col-3">{store.detalleVehiculo.name}</h6>
//           <h6 className="col-3">{store.detalleVehiculo.cargo_capacity}</h6>
//           <h6 className="col-3">{store.detalleVehiculo.max_atmosphering_speed}</h6>
//           <h6 className="col-3">{store.detalleVehiculo.crew}</h6>
